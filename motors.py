...
def smooth_turn(robot_instance, direction):
    """
    Executes a smooth  arc by driving all wheels forward, 
    spinning the outside wheels faster than the inside wheels.
    """
    fast_speed = 0.35  # Outside wheels 
    slow_speed = 0.15  # Inside wheels 
